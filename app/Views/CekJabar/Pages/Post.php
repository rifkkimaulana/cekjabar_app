	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6 col-lg-8">
				<div class="row">
					...
					<div class="col-6 text-right">
						<div class="page_comments">
							<ul class="inline">
								<li><i class="fas fa-eye"></i>563</li>
								<li><i class="fas fa-comment"></i>536</li>
							</ul>
						</div>
					</div>
				</div>
				...
				<img class="border-radious5" src="assets/cekjabar/img/blog/single_post1.jpg" alt="image">
				...
				<p>Entilators will be taken from certain New York hospitals and redistributed to the worst-hit parts of the state under an order to be signed by Governor Andrew Cuomo.
					...
					<br>
					<br>“You’ve got to put your foot on the accelerator to bring that number down,” he added, referring to infection and death rates.
				</p>
				<div class="space-40"></div>
				<div class="points">
					<ul>
				...
				<p>The comments from Dr Fauci, who heads the National Institute of Allergy and Infectious Diseases, appeared to contradict those of President Trump, who has consistently dismissed the notion of a nationwide lockdown.
					<br>
					<br>“It’s awfully tough to say, ‘close it down.’ We have to have a little bit of flexibility,” Mr Trump said on Wednesday.
				</p>
				<div class="space-40"></div>
				...
				<p>Both the US Centers for Disease Control (CDC) and the World Health Organization (WHO) are reassessing their guidance on face masks, as experts race to find ways to fight the highly contagious virus.
					<br>
					<br>Covid-19 is carried in airborne droplets from people coughing or sneezing, but there is some dispute over how far people should distance themselves from each other, and whether masks are useful when used by the public.
				</p>
				<div class="space-40"></div>
				<div class="row">
					<div class="col-md-6">
						<img class="border-radious5" src="assets/cekjabar/img/blog/smail1.jpg" alt="">
					</div>
					<div class="col-md-6">
				...
				<p>Masks may also help lower the risk of individuals catching the virus through the droplets from another person’s sneeze or a cough - and people can be taught how put masks on and take them off correctly, they argue.
					...
					<br>
					<br>Meanwhile, residents in Laredo, Texas will now face a $1,000 (£816) fine if they fail to cover their noses and mouths while outside, after city officials issued an emergency ordinance to its approximately 250,000 residents this week.
				</p>
				<div class="space-40"></div>
				...
				<div class="space-40"></div>
				<img class="border-radious5" src="assets/cekjabar/img/blog/big1.jpg" alt="">
				<p class="img_desc"><span>I just had a baby - now I’m going to the frontline.</span></p>
				<div class="space-40"></div>
				<p>Masks may also help lower the risk of individuals catching the virus through the droplets from another person’s sneeze or a cough - and people can be taught how put masks on and take them off correctly, they argue.
					<br>
					<br>On Thursday New York mayor Bill de Blasio urged all New Yorkers to cover their faces when outside and near others, but not to use surgical masks, which are in short supply.
				...
				<div class="row">
					<div class="col-md-5">
						<img class="border-radious5" src="assets/cekjabar/img/blog/quote_1.jpg" alt="">
					</div>
					<div class="col-md-7">
						<div class="qhote">
							<img src="assets/cekjabar/img/icon/q4.png" alt="">
				...
				<p>In global terms the US has the most Covid-19 cases - more than 245,000. And on Thursday the US authorities said more than 1,000 had died in the past 24 hours - the highest daily toll so far in the world.
					<br>
					<br>Hospitals and morgues in New York are struggling to cope with the pandemic, and New York Governor Andrew Cuomo has warned that New York risks running out of ventilators for patients in six days.
				</p>
				<div class="space-40"></div>
				<div class="tags">
					<ul class="inline">
			...
			<div class="col-md-6 col-lg-4">
				<div class="single_post post_type3 shadow7 mb30 post_type15 border-radious5">
					<div class="post_img border-radious5">
						<div class="img_wrap">
							<a href="#">
								<img src="assets/cekjabar/img/blog/video32.jpg" alt="">
							</a>
					...
					<div class="single_post_text padding20 white_bg">
						<h4><a href="post1.html">Japan’s virus puzzled the world luck running out?</a></h4>
						<div class="space-10"></div>
